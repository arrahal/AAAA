...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col justify-between max-w-md mx-auto shadow-2xl relative overflow-x-hidden font-['Cairo',sans-serif]">
      {/* Header */}
      <Header
        db={db}
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        {currentTab === 'pupils' && <PupilsTab db={db} onUpdateDb={handleUpdateDb} />}
