...
export const AbsencesTab: React.FC<AbsencesTabProps> = ({ db, onUpdateDb, onOpenBulkAbsenceModal }) => {
    ...
    <div className="p-4 space-y-4 max-w-2xl mx-auto pb-20">
      ...
      <div className="flex items-center justify-between gap-2">
        <div>
          <h2 className="text-base font-extrabold text-slate-800 flex items-center gap-1.5">
            ...
            <span>قسم تتبع وخصم غياب التلاميذ</span>
          </h2>
          <p className="text-xs text-slate-500 font-medium">متابعة المواظبة والغيابات الشهرية لكافة الأفواج</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div className="bg-gradient-to-br from-rose-500 to-red-600 text-white rounded-2xl p-3 shadow-sm">
          ...
          <span className="text-[10px] text-rose-100 font-bold mt-1 block">إجمالي الغيابات</span>
        </div>
        ...
        <div className="bg-gradient-to-br from-amber-500 to-orange-600 text-white rounded-2xl p-3 shadow-sm">
          ...
          <span className="text-[10px] text-amber-100 font-bold mt-1 block">نسبة الغياب</span>
        </div>
        ...
        <div className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white rounded-2xl p-3 shadow-sm">
          ...
          <span className="text-[10px] text-indigo-100 font-bold mt-1 block">أفواج متجاوزة (&gt;3)</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-3 border border-slate-200 shadow-sm flex gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="بحث بالمدرسة، الأستاذ، اسم الفوج..."
      ...
      {filteredGroups.length === 0 ? (
        <div className="bg-white rounded-2xl p-8 text-center border border-slate-200 space-y-2">
          ...
          <h3 className="text-sm font-bold text-slate-800">لا توجد نتائج مطابقة للبحث</h3>
          <p className="text-xs text-slate-500">أضف أفواج جديدة أو غير معايير البحث لعرض الغيابات.</p>
        </div>
      ) : (
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-slate-500 font-medium mt-1">
                    الأستاذ: {anim ? anim.nom : '—'} · {g.eff} تلميذ ({g.filles} إناث / {g.garcons} ذكور)
                  </p>
                </div>
